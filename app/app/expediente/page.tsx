...
import { demoUser, demoRecords, demoPatient } from "../../../lib/demo"
...
export default async function ExpedientePage() {
  ...
  if (!session && isDemo) {
    return <ExpedienteClient records={demoRecords} patient={demoPatient} user={demoUser} />
  }
  ...
  `.catch(() => []).then(r => (r as any[])[0] || null)

  return <ExpedienteClient
    records={(records as any[]).length ? records : demoRecords}
